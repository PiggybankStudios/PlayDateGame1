...
set MainSourcePath=%SourceDirectory%\main.c
...
set OutputObjPdbName=%ProjectNameSafe%_%TimeString%_obj.pdb
...
set CompilerFlags=/GS /Zi /Gm- /Od /RTC1 /std:c11 /Gd /MDd /Zc:wchar_t /Ob0 /Zc:inline /fp:precise /W3 /WX- /nologo
set CompilerFlags=%CompilerFlags% /Fd"%OutputObjPdbName%" /Fp"%ProjectNameSafe%.pch"
set CompilerFlags=%CompilerFlags% /D "_WINDLL" /D "_MBCS" /D "WIN32" /D "_WINDOWS" /D "TARGET_SIMULATOR=1" /D "_WINDLL=1" /D "TARGET_EXTENSION=1" /D "CMAKE_INTDIR=\"Debug\"" /D "hello_world_EXPORTS"
